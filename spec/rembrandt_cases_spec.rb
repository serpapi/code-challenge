...
RSpec.describe 'Runner results for Rembrandt paintings carousel' do
  ...
  let(:output_path) do
    ...
    _output_path = File.join(project_root, 'rembrandt-paintings-output.json')
  end

  let(:input_file_url) do
    spec_root = File.expand_path(__dir__)
    file_path = File.join(spec_root, 'fixtures/pages/rembrandt-van-rjin.html')
  ...
  let(:expected_result) do
    spec_root = File.expand_path(__dir__)
    file_path = File.join(spec_root, 'fixtures/expected/rembrandt-results.json')
