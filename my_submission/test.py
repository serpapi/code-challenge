...
class TestCarrousel(unittest.TestCase):
    OUTPUT_FILE="actual_array.json"
    SERVER_NAME="www.google.com"
    INPUT_FILE=urljoin(os.getcwd(),"/van-gogh-paintings.html")

    @classmethod
    def setUpClass(self):
        os.system("carrousel.py"+" "+self.SERVER_NAME+" "+self.INPUT_FILE)
        with open(self.OUTPUT_FILE,"r") as f:
            self.carrousel_json=json.load(f)

    def test_heading(self):
        self.assertTrue('artworks' in self.carrousel_json)

    def test_arr(self):
        my_list=self.carrousel_json['artworks']
        self.assertTrue(isinstance(my_list, list))
        self.assertTrue(len(my_list)>0)

    def test_name(self):
        name=self.carrousel_json['artworks'][0]['name']
        self.assertEqual(name,"The Starry Night")

    def test_extensions(self):
        extensions=self.carrousel_json['artworks'][0]['extensions']
        self.assertEqual(extensions,["1889"])

    def test_link(self):
        link=self.carrousel_json['artworks'][0]['link']
    ...
    def test_image(self):
        image=self.carrousel_json['artworks'][0]['image']
