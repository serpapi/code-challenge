...
class CarouselPaintingTileV1
  NAME_PATH = ".//div/div[@class = 'kltat']".freeze
  EXTENSIONS_PATH = ".//div/div[@class = 'ellip klmeta']".freeze
  ...
  def data
    ...
    {
      name: @node.xpath(NAME_PATH).text.encode('utf-8'),
