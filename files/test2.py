# This is for Test term on Google: "Famous Basketball Players"
...
driver.get('https://www.google.com/search?q=Famous+Basketball+Players&oq=Famous+Basketball+Players&aqs=chrome..69i57.4152j0j1&sourceid=chrome&ie=UTF-8')
...
for i in x:
	...
	with open('Test2-Basketball-Players.json', 'w') as file:
