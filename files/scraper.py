...
for image_element in image_elements:
  ...
  # Currently getting incorrect image data, seems it may be placeholder image instead of img src, need to find real data from JS script, maybe using something like selenium
