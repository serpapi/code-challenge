...
Example: `GoogleSearchPageCrawler::Parser::ListResult`, `GoogleSearchPageCrawler::Parser::Artworks`, etc. Each class is responsible for parsing a specific section of the page and format the result. I don't think that this is strictly necessary but may help to lower the cognitive load when reading the "parser" class if it gets too big and also would facilitate fixing some broken parsing rule.
