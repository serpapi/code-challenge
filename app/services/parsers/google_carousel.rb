module Parsers
  class GoogleCarousel < Base
    ...
    CAROUSEL_SLIDER_CLASS = 'EDblX' # This ensures that we fetch only carousel items from the top
    CAROUSEL_SLIDER_ITEM_CLASS = 'MiPcId'
    ...
    def call
      paintings_slider_elements_html = document.search(".#{CAROUSEL_SLIDER_CLASS} .#{CAROUSEL_SLIDER_ITEM_CLASS}")
